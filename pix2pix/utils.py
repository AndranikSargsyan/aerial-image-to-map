...
def save_some_examples(gen: torch.nn.Module, val_loader: torch.utils.data.DataLoader,
                       epoch: int, folder: str, device: str):
    """
    ...
    Args:
        ...
        device (str): The device to run the generator on.
    """
...
def load_checkpoint(checkpoint_file: str, model: torch.nn.Module,
                    optimizer: torch.optim.Optimizer, lr: float, device: str):
    """
    ...
    Args:
        ...
        device (str): The device to load the checkpoint onto.
   """
