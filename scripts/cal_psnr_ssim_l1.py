...
def get_args():
    ...
    parser.add_argument('--gt-path', type=str, required=True, help='Path to gt images.')
    parser.add_argument('--pred-path', type=str, required=True, help='Path to predicted images.')
